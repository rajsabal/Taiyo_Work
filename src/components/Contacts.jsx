                        ...
                        <div id="data_container">
                            {data.map((el)=>(
                              <div key={el.id}>
                                ...
                                <Popover >
                                   <PopoverTrigger  >
                                    <button onClick={viewContact} style={{backgroundColor:"Blue"}}>View</button>
                                   </PopoverTrigger>
                            ...
                            <button onClick={()=>deleteContact(el.id)} style={{ color:"white",backgroundColor:"gray"}}>Delete</button>
                              </div>
                            ))} 
                        </div>
                    </Box>
